...
| `stremio-faithful-cutover-plan.md` | 全仓（core 优先，web/desktop/addon-sdk 随动） | 🔨 P0–P3 全落地+实测；P4 退役：live/详情已删，2026-09-12 又切走豆瓣搜索、bangumi 日历、`/api/search*`、`/api/proxy/vod/*`。剩 douban recommends/categories、logo/image-proxy、账户/admin。updater 首次验证后置。 |
